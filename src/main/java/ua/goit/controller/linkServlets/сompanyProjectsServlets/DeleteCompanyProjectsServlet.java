...
@WebServlet("/deleteCompanyProjects")
public class DeleteCompanyProjectsServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("/view/delete/links/deleteCompanyProjectsFrom.jsp").forward(req, resp);
    }
